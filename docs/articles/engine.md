...
[`filter()`](https://gcol33.github.io/vectra/reference/filter.md) does
...
| Function | Format | Streaming |
|:---|:---|:---|
| [`collect()`](https://gcol33.github.io/vectra/reference/collect.md) | R data.frame | materializes full result in R memory |
...
| `mutate(...)` | yes | Arithmetic, comparison, boolean, [`is.na()`](https://rdrr.io/r/base/NA.html), [`nchar()`](https://rdrr.io/r/base/nchar.html), [`substr()`](https://rdrr.io/r/base/substr.html), [`grepl()`](https://rdrr.io/r/base/grep.html) |
| `transmute(...)` | yes | Like [`mutate()`](https://gcol33.github.io/vectra/reference/mutate.md) but drops unmentioned columns |
...
| [`ungroup()`](https://gcol33.github.io/vectra/reference/ungroup.md) | metadata only | Removes grouping |
| `count(...)` | **materializes** | Sugar for `group_by() |> summarise(n = n())` |
| `tally(...)` | **materializes** | Like [`count()`](https://gcol33.github.io/vectra/reference/count.md) on existing groups |

Supported aggregation functions: `n()`,
[`sum()`](https://rdrr.io/r/base/sum.html),
[`mean()`](https://rdrr.io/r/base/mean.html),
[`min()`](https://rdrr.io/r/base/Extremes.html),
[`max()`](https://rdrr.io/r/base/Extremes.html). All accept
`na.rm = TRUE`.
...
| `across(...)` | n/a | Column expansion helper for [`mutate()`](https://gcol33.github.io/vectra/reference/mutate.md)/[`summarise()`](https://gcol33.github.io/vectra/reference/summarise.md) |
| [`explain()`](https://gcol33.github.io/vectra/reference/explain.md) | n/a | Prints the plan tree |
...
[`filter()`](https://gcol33.github.io/vectra/reference/filter.md) and
[`mutate()`](https://gcol33.github.io/vectra/reference/mutate.md)
...
[`arrange()`](https://gcol33.github.io/vectra/reference/arrange.md) uses
an external merge sort when accumulated data exceeds 1 GB. Sorted runs
are spilled to temporary `.vtr` files, then merged via a k-way min-heap.
...
[`explain()`](https://gcol33.github.io/vectra/reference/explain.md) runs
the optimizer before printing so you see the actual execution plan. Two
optimization passes run automatically:
...
This is visible in
[`explain()`](https://gcol33.github.io/vectra/reference/explain.md) as
...
[`explain()`](https://gcol33.github.io/vectra/reference/explain.md)) to
...
- **Limited string operations**:
  ...
  [`grepl()`](https://rdrr.io/r/base/grep.html) (fixed match only) are
  supported. No regex, [`paste()`](https://rdrr.io/r/base/paste.html),
  [`toupper()`](https://rdrr.io/r/base/chartr.html), etc. Use
  [`collect()`](https://gcol33.github.io/vectra/reference/collect.md)
...
2.  **distinct with .keep_all and column subset**: Falls back to
    [`duplicated()`](https://rdrr.io/r/base/duplicated.html) in R.

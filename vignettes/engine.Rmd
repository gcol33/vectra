...
case-insensitive flag, and the row and row-group counts of the store at build
time, followed by the entries in ascending hash order and a directory giving the
first entry for each range of leading hash bits.

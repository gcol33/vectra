...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"C_append_vtr",     (DL_FUNC) &C_append_vtr,     3},
    ...
    {"C_create_index",      (DL_FUNC) &C_create_index,      4},
    {"C_has_index",         (DL_FUNC) &C_has_index,         2},
    {"C_index_spec",        (DL_FUNC) &C_index_spec,        2},
    {"C_extend_index",      (DL_FUNC) &C_extend_index,      4},
    {"C_store_fingerprint", (DL_FUNC) &C_store_fingerprint, 1},
